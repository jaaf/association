 ...
 <div id="option" class="carousel carousel-fade container banner  d-none d-sm-block" data-ride="carousel" data-interval="9000">
    <div id="carouselExampleSlidesOnly"
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo asset('storage/banner/banner-004.jpg'); ?>" alt="Third slide" />
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo asset('storage/banner/banner-005.jpg'); ?>" alt="Third slide" />
        </div>
        <div class="carousel-item">
