    ...
    <nav class="navbar navbar-expand-sm  ">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"> Récits</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    {{--<a class="dropdown-item" href="">Liste des
                        adhérents</a>--}}
                    {{--<a class="dropdown-item" href="#">Enquêtes
                        ouvertes</a>--}}
                </div>
            </li>
            <!-- Dropdown -->
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="{{ route('posts.show', ['post' => 138]) }}">Aspects techniques de ce
                        site</a>
                    <a class="dropdown-item" href="{{ route('posts.show', ['post' => 140]) }}">Utiliser ce site
                        efficacement</a>
                    <a class="dropdown-item" href="{{ route('posts.show', ['post' => 142]) }}">Accédez aux vidéos et
